...
if __name__ == '__main__':
    ...
    for max_ngram in max_ngrams:
        ...
        if max_ngram == 1:
            ...
            tfidfv = pickle.load(open('../tfidfv_1_2gram.p', 'rb'))
            tfidf_X_train = pickle.load(open('../tfidf_X_train_1_2gram.p', 'rb'))
            tfidf_X_test = pickle.load(open('../tfidf_X_test_1_2gram.p', 'rb'))
        ...
        print('For max_ngram: {0}'.format(max_ngram))
